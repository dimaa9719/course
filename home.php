				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body" style="background:#38B9EC">
							<h3 class="course_title"><a href="computing.php" style="color: white;">COMPUTING</a></h3>				
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body" style="background:rgb(226, 123, 27)">
							<h3 class="course_title"><a href="business.php"  style="color: white;">BUSINESS</a></h3>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body" style="background:rgb(15, 190, 83)">
							<h3 class="course_title"><a href="engineering.php"  style="color: white;">ENGINEERING</a></h3>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body" style="background:#FD1F0F">
							<h3 class="course_title"><a href="designing.php"  style="color: white;">DESIGNING</a></h3>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body" style="background:#B63493">
							<h3 class="course_title"><a href="photography.php"  style="color: white;">PHOTOGRAPHY</a></h3>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body" style="background:#A2821A">
							<h3 class="course_title"><a href="music.php"  style="color: white;">MUSIC</a></h3>
						</div>
					</div>
				</div>
