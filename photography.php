					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<?php  if (($_SESSION['user']['user_type']) == 'user') : ?>
									...
									<li class="active"><a href="photography.php">Courses</a></li>									
			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="course_container">
						<div class="course_title">Photography</div>
						<div class="course_info d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">

							<!-- Course Info Item -->
							<div class="course_info_item">
								<div class="course_info_title">Lecurer In-Charge:</div>
								<div class="course_info_text"><a href="#">Mr.Kim Lee</a></div>
							</div>
						...
						<!-- Course Image -->
						<div class="course_image"><img src="images/photography.jpg" alt=""></div>
						...
						<div class="course_tabs_container">
							...
							<div class="tab_panels">
								...
								<div class="tab_panel active">
									<div class="tab_panel_title">Photography</div>
									<div class="tab_panel_content">
										...
										<div class="tab_panel_section">
											...
											<div class="tab_panel_text">
												<p>This course is intended for anyone interested in learning to master his or her knowledge on Photography.This course is aimed at beginners, so no previous experience with hand balancing skillts is necessary. </p>
											</div>
										</div>
									...
									<div class="tab_panel_content">
										...
										<div class="tab_panel_content">
											...
											<?php
												...
												$result = $mysqli->query("SELECT * FROM photography") or die($mysqli->error); 
											?>
											<ul class="dropdowns">
														...
														<div class="accordion_container" >
															<div class="accordion d-flex flex-row align-items-center" ><div>Enroll </div></div>
																<div class="accordion_panel">
																	<form method="post" action="photography.php">
																	...
																	<input type="submit" class="btn btn-success"  name="pay_btn4" value="Pay">
																	</div>
																</form>	
																</div>
															</div>
						...
						<div class="sidebar_section">
							...
							<div class="sidebar_teacher">
								<div class="teacher_title_container d-flex flex-row align-items-center justify-content-start">
									<div class="teacher_image"><img src="images/team_8.jpg" alt=""></div>
									<div class="teacher_title">
										<div class="teacher_name"><a href="#">Mr.Kim Lee</a></div>
										<div class="teacher_position">Professional Photographer</div>
									</div>
								</div>
								...
								<div class="teacher_info">
	 								<p> Hi! I'm Kim Lee, I will be the Lecturer in-charge for this course. Please feel free to contact me any time. I will be there for your convenience</p>
								</div>
							</div>
						</div>
