...
<div>
	<div class="modal-dialog modal-login">
		<div class="modal-content">
			<a href="manager_home.php" style="position:initial; color:black;"><i class="fa fa-times-circle" style="left: 350px;"></i></a>
      	...
      	<div class="panel-heading ">
			...
			<div class="modal-body">
				<form method="post"  action="create_user.php">
					...
					<div class="form-group">
						<input type="submit" class="btn btn-primary btn-block btn-lg" name="register_btn" value="Create User">
					</div>
				</form>					
			</div>
		</div>
