...
<div class="super_container">
	...
	<?php
		...
		$re1 = $mysqli->query("SELECT * FROM engineering  WHERE course_code = '$code' ") or die($mysqli->error);
		...
		<?php while($row = $re1->fetch_assoc()): ?>
			...
			<div class="sidebar">
					...
					<div class="sidebar_section">
						<div class="sidebar_section_title">Latest Engineering Courses</div>
						<div class="sidebar_latest">
							...
							<div class="latest d-flex flex-row align-items-start justify-content-start">
								<a href="engineering.php" class="btn btn-primary  justify-content-start"> Show More </a>
							</div>
