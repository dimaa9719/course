...
<div class="super_container">
	...
	<?php
		...
		$re1 = $mysqli->query("SELECT * FROM $category  WHERE course_code = '$code' ") or die($mysqli->error);
		...
		<?php while($row = $re1->fetch_assoc()): ?>
			...
			<div class="sidebar">
					...
					<div class="sidebar_section">
						<div class="sidebar_section_title">Latest <?php echo $_POST['category']; ?> Courses</div>
